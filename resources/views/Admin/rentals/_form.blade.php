...
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label for="user_id" class="block text-sm font-medium text-gray-700">{{ __('Penyewa') }}</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600 space-y-2">
            <p class="font-medium text-gray-700">{{ __('Ketentuan Peminjaman') }}</p>
