<x-app-layout>
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="p-6">
                        ...
                        <form method="POST" action="{{ route('rentals.store') }}" id="rentalForm">
                            ...
                            <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="font-semibold text-emerald-600 dark:text-emerald-300"
                                            id="availableBalance">Rp 0</span>
                                    </div>
                                    <div
                                        class="border-t border-gray-300 dark:border-gray-600 pt-2 flex justify-between">
                                        <span class="font-semibold text-gray-900 dark:text-white">Total Biaya:</span>
                                        <span class="font-bold text-blue-600 dark:text-blue-400" id="totalCost">Rp
                                            0</span>
                                    </div>
                                ...
                                <p class="mt-3 text-xs text-red-600 dark:text-red-400 hidden" id="balanceWarning"></p>
                            </div>
                            ...
                            <div class="mb-6">
                                <div class="flex items-start">
                                    ...
                                    <label for="terms_accepted" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                        Saya menyetujui <a href="#" class="text-blue-600 hover:text-blue-500">syarat dan
                                            ketentuan</a> <span class="text-red-500">*</span>
                                    </label>
                                </div>
                ...
                <div class="space-y-6">
                    ...
                    <!-- Rental Rules -->
                    <div
                        class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                        <div class="p-6">
                            ...
                            <ul class="space-y-2 text-sm text-yellow-800 dark:text-yellow-200">
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 mr-2 mt-0.5 text-yellow-600" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z">
                                        </path>
                                ...
                                <li class="flex items-start">
                                    ...
                                    <span><strong>Denda keterlambatan:</strong> 50% dari tarif harian per hari
                                        terlambat</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 mr-2 mt-0.5 text-yellow-600" fill="none" stroke="currentColor"
                                    ...
                                    <span><strong>Perpanjangan:</strong> Maksimal 5 hari perpanjangan (total maksimal 10
                                        hari)</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 mr-2 mt-0.5 text-yellow-600" fill="none" stroke="currentColor"
                                    ...
                                    <span><strong>Pembayaran:</strong> Pembayaran penuh diperlukan sebelum aktivasi
                                        server</span>
                                </li>
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 mr-2 mt-0.5 text-yellow-600" fill="none" stroke="currentColor"
    ...
    <script>
        ...
        if (availableBalance) {
            availableBalance.textContent = 'Rp ' + userBalance.toLocaleString('id-ID');
        }
        ...
        function updateCostCalculation() {
            ...
            if (balanceAfter) {
                const balanceToDisplay = days > 0 ? remainingBalance : userBalance;
                balanceAfter.textContent = 'Rp ' + balanceToDisplay.toLocaleString('id-ID');

                if (days > 0 && remainingBalance < 0) {
            ...
            if (balanceWarning) {
                if (days > 0 && remainingBalance < 0) {
                    ...
                    balanceWarning.textContent = 'Saldo Anda kurang Rp ' + Math.abs(remainingBalance).toLocaleString('id-ID') + ' untuk memesan periode ini.';
                } else {
