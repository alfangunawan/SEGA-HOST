                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white">Rp
                                    {{ number_format($userBalance, 0, ',', '.') }}</p>
                            </div>
                        </div>
                        @if($userBalance <= 0)
                            <p class="mt-4 text-xs text-rose-600 dark:text-rose-400 font-medium">
                                Saldo Anda habis. Lakukan top up sebelum memesan server baru.
                            </p>
                        @elseif($userBalance < 250000)
                            <p class="mt-4 text-xs text-amber-600 dark:text-amber-400 font-medium">
                                Saldo menipis. Pertimbangkan untuk melakukan top up agar transaksi tetap lancar.
                            </p>
                        @else
                            <p class="mt-4 text-xs text-gray-500 dark:text-gray-400">
                                Saldo akan otomatis terpotong ketika Anda melakukan pemesanan server.
                            </p>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900 dark:text-white">Rp
                                    {{ number_format($monthlySpending, 0, ',', '.') }}</p>
                                    ...
                                    @foreach($recentRentals as $rental)
                                        <div
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div
                                                    class="p-2 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-600 dark:to-gray-500 rounded-lg">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <a href="{{ route('products.index') }}"
                                ...
                                @if(!Auth::user()->canRentMoreServers())
                                    onclick="event.preventDefault(); alert('You have reached the maximum limit of 2 active server rentals.');"
                                @endif>
                                Browse Products
                            </a>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 dark:text-gray-400 mb-4 text-sm">View your past and current orders
                            </p>
                            <a href="{{ route('rentals.index') }}"
                                class="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-4 rounded-lg transition-colors block text-center">
                                View Orders
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        <div class="p-3 bg-orange-100 dark:bg-orange-900 rounded-full w-12 h-12 mx-auto mb-3">
                            <svg class="w-6 h-6 text-orange-600 mx-auto" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        <div class="p-3 bg-indigo-100 dark:bg-indigo-900 rounded-full w-12 h-12 mx-auto mb-3">
                            <svg class="w-6 h-6 text-indigo-600 mx-auto" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        <div class="p-3 bg-gray-100 dark:bg-gray-700 rounded-full w-12 h-12 mx-auto mb-3">
                            <svg class="w-6 h-6 text-gray-600 dark:text-gray-400 mx-auto" fill="none"
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 font-medium text-sm">
                            Manage Account
                        </a>
                    </div>
                </div>
